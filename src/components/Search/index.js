...
const Search = () => {
  return (
    <div
      className="col-xxl-4 col-xl-4 col-lg-6 col-md-6 col-sm-6 col-10 d-flex align-self-center position-relative border border-dark py-2 rounded rounded-2  searchbox"
      style={{ height: '65px' }}
    >
