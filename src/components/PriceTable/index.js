    ...
    <div className="col-12 d-flex flex-column">
      <div className="col-12 d-flex flex-row flex-wrap" style={{ minHeight: '40vh' }}>
        ...
        <div className="col d-flex flex-column justify-content-center align-items-center border-start">
          <h3 className="h-25 blueText">בסיסי</h3>
          <span className="fs-6 border-bottom col-12">עד 3</span>
          <span className="fs-6 border-bottom col-12"><img src="../assets/icons/out.svg" height="20" width="20"/></span>
          <span className="fs-6 border-bottom col-12"><img src="../assets/icons/out.svg" height="20" width="20"/></span>
          <span className="fs-6 border-bottom col-12"><img src="../assets/icons/out.svg" height="20" width="20"/></span>
          ...
          <div className="btn cream border col-10 m-2 tableBtn">הצג</div>
        </div>
        <div className="col d-flex flex-column justify-content-center align-items-center border-start cream">
          <h3 className="h-25 blueText">מקיף</h3>

          <span className="fs-6 border-bottom col-12">עד 7</span>
          <span className="fs-6 border-bottom col-12"> <img src="../assets/icons/check.svg" height="20" width="20"/></span>
          <span className="fs-6 border-bottom col-12"><img src="../assets/icons/out.svg" height="20" width="20"/> </span>
          <span className="fs-6 border-bottom col-12"><img src="../assets/icons/out.svg" height="20" width="20"/></span>
          <span className="fs-6 border-bottom col-12">מיידי</span>
          <span className="fs-6 border-bottom col-12">XX</span>
          ...
          <div className="btn cream border col-10 m-2 align-self-center tableBtn">רכישה</div>

        </div>
        <div className="col d-flex flex-column justify-content-center align-items-center border-start ">
        <h3 className="h-25 blueText">התאמה אישית</h3>
          ...
          <div className="btn cream border col-10 m-2 align-self-center tableBtn">קבע פגישה</div>

        </div>

        <div className="col d-flex flex-column justify-content-center align-items-center border-start cream">
          <h3 className="h-25 blueText">פגישת ייעוץ</h3>
          <span className="fs-6 border-bottom col-12">עד 3</span>
          <span className="fs-6 border-bottom col-12"> X</span>
          <span className="fs-6 border-bottom col-12">X </span>
          <span className="fs-6 border-bottom col-12">X</span>
