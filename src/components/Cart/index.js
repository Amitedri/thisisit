...
const Cart = ({ openCart,setOpenCart }) => {
  ...
  return (
    <div className="col-xxl-4 col-xl-4 col-lg-6 col-md-6-col-sm-10 col-10 position-absolute start-0 top-100 position-relative shadow-lg border border-dark" style={{ zIndex: '9999' }}>
      <span
      ...
      <div className="col-12 bg-white position-absolute top-0 cartContainer d-flex flex-column align-items-center">
        ...
        <div className="col-11 f18 border rounded bg-light text-center p-2">
        ...
        <div className="col-12 d-flex flex-column align-items-center purContainer">
          {/* product */}
          <div className="col-12 d-flex align-items-center  d-flex flex-column shadow-sm">
