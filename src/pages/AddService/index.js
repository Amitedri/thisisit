  ...
  return (
    <div className="col-12 d-flex flex-column align-items-center justify-content-center align-content-center">
      ...
      <div className="col-12 d-flex flex-column justify-content-center align-items-center justify-content-center m-2">
        ...
        <div class="form-group m-2 d-flex flex-column bg-white col-xxl-6 col-xl-6 col-12 rounded shadow-sm p-2 justify-content-center">
      ...
      <div class="input-group-prepend  col-xxl-6 col-xl-6 col-12 m-2 d-flex flex-column justify-content-center align-items-center">
