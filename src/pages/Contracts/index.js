  ...
  return (
    <div className="col-xxl-10 col-xl-10 col-lg-12 col-md-12 col-sm-12 col-12 m-auto d-flex flex-column align-items-center">
      ...
      <div className="col-12 mt-2 d-flex flex-row align-items-center flex-wrap ">
        <div className="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12 text-xxl-end text-xl-end text-lg-end text-md-end text-sm-center text-center d-flex flex-column align-items-center justify-content-center">
          <p className="f16 m-1 col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">מהיום, לא צריך לשלם אלפי שקלים עבור רכישת הסכמים וחוזים, בדף זה תוכלו למצוא עשרות הסכמים לדוגמא מכל תחומי המשפט. </p>
          <hr className="w-90 m-1 col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" />
          <ul className="f16 text-end d-flex flex-column w3 col-xxl-8 col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12">
