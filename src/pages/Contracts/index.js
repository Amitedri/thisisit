      ...
      <div className="col-12 mt-2 d-flex flex-row align-items-center flex-wrap">
        ...
        <div className="col-6 d-flex flex-column justify-content-center">
          <div className="col-12 d-flex flex-row flex-wrap text-center justify-content-center">
            <div className="col-3 d-flex flex-column justify-content-center align-items-center m-1 border-bottom shadow-sm border border-light">
              <span className="col-8 h-50">עלות שווה לכל נפש</span>
              <img className="m-2" src="../assets/icons/like-heart-round-line.svg" height="25" width="25" />
            </div>
            <div className="col-3 d-flex flex-column justify-content-center align-items-center m-1 border-bottom shadow-sm border border-light">
              <span className="col-8 h-50">התאמה אישית תוך 48 שעות</span>
              <img className="m-2" src="../assets/icons/man-mobile-chat.svg" height="25" width="25" />
            </div>
            <div className="col-3 d-flex flex-column justify-content-center align-items-center m-1 border-bottom shadow-sm border border-light">
              <span className="col-8 h-50">קביעת פגישת און ליין</span>
              <img className="m-2" src="../assets/icons/reservation.svg" height="25" width="25" />
            </div>
          </div>
          <div className="col-12 d-flex flex-row flex-wrap text-center justify-content-center">
            <div className="col-3 d-flex flex-column justify-content-center align-items-center m-1 border-bottom shadow-sm border border-light">
              <span className="col-8 h-50">שירות מקצועי ומהיר</span>
              <img className="m-2" src="../assets/icons/five-stars.svg" height="25" width="25" />
            </div>
            <div className="col-3 d-flex flex-column justify-content-center align-items-center m-1 border-bottom shadow-sm border border-light">
              <span className="col-8 h-50">הסכם מלא ומקיף</span>
              <img className="m-2" src="../assets/icons/excellence-honor.svg" height="25" width="25" />
            </div>
            <div className="col-3 d-flex flex-column justify-content-center align-items-center m-1 border-bottom shadow-sm border border-light">
              <span className="col-8 h-50">ייעוץ ראשוני ללא עלות</span>
              <img className="m-2" src="../assets/icons/free-time.svg" height="25" width="25" />
            </div>
          </div>
        </div>
      </div>
