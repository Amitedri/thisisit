...
var makeMekifProductEmailTemplate = function makeMekifProductEmailTemplate(_ref6) {
  var name = _ref6.name,
      phone = _ref6.phone,
      email = _ref6.email,
...
var makeCustomProductEmailTemplate = function makeCustomProductEmailTemplate(_ref7) {
  var name = _ref7.name,
      phone = _ref7.phone,
      email = _ref7.email,
...
var sendEmail = function sendEmail(_ref8) {
  var name, phone, data, subject, result;
  return regeneratorRuntime.async(function sendEmail$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          name = _ref8.name, phone = _ref8.phone, data = _ref8.data, subject = _ref8.subject;
          _context2.next = 3;
...
var sendEmailWithoutAttachment = function sendEmailWithoutAttachment(_ref9) {
  var data, subject, target, result;
  return regeneratorRuntime.async(function sendEmailWithoutAttachment$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          data = _ref9.data, subject = _ref9.subject, target = _ref9.target;
          _context3.next = 3;
          return regeneratorRuntime.awrap(transporter.sendMail({
            from: 'cecotechside@gmail.com',
            // to: "Sale@hareli.co.il
...
var sendEmailWithAttachment = function sendEmailWithAttachment(_ref10) {
  ...
  return regeneratorRuntime.async(function sendEmailWithAttachment$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          data = _ref10.data, subject = _ref10.subject, contractName = _ref10.contractName, target = _ref10.target;
          _context4.next = 3;
          return regeneratorRuntime.awrap(transporter.sendMail({
            from: 'cecotechside@gmail.com',
            // to: "Sale@hareli.co.il
